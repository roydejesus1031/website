# The provider ID that has to be given to Github Actions to deploy the website
...
# The Service Account that has to be given to Github Actions to deploy the website
output "site_deployer_svc_acc" {
  value     = google_service_account.site_deployer.email
  sensitive = true
}

# The provider ID that has to be given to Github Actions to manage Terraform
...
# The Service Account that has to be given to Github Actions to manage Terraform
